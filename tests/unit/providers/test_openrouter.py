...
class TestOpenRouterProviderModelName:
    ...
    def test_model_name_constant(self):
        from packages.llm_providers.providers.openrouter import OpenRouterProvider
...
class TestOpenRouterProviderInit:
    ...
    @patch("packages.llm_providers.providers.openrouter.os.getenv")
    @patch("packages.llm_providers.providers.openrouter.ChatOpenAI")
