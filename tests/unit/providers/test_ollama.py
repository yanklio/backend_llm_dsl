...
class TestOllamaProviderModelName:
    ...
    def test_model_name_constant(self):
        from packages.llm_providers.providers.ollama import OllamaProvider
...
class TestOllamaProviderInit:
    ...
    @patch("packages.llm_providers.providers.ollama.requests.get")
    @patch("packages.llm_providers.providers.ollama.ChatOllama")
